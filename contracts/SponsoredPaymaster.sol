...
contract SponsoredPaymaster is BasePaymaster {
    ...
    function _validatePaymasterUserOp(
        ...
        // require at least: static fields (52) + (validUntil+validAfter) 12 + signature 65
        if (paymasterAndData.length < PAYMASTER_DATA_OFFSET + 12 + 65) {
        ...
        bool sigFailed = ECDSA.recover(digest, signature) != verifyingSigner;
